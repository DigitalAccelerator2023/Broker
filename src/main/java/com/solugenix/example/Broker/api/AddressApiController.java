...
import com.solugenix.example.Broker.model.Address;
...
public class AddressApiController implements AddressApi {
    ...
    public ResponseEntity<List<Address>> getAddress() {
        ...
        if (accept != null && accept.contains("application/xml")) {
            try {
                return new ResponseEntity<List<Address>>(objectMapper.readValue("<Address>  <streetName>aeiou</streetName>  <city>aeiou</city>  <country>aeiou</country></Address>", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<Address>>(objectMapper.readValue("[ {  \"country\" : \"country\",  \"streetName\" : \"streetName\",  \"city\" : \"city\"}, {  \"country\" : \"country\",  \"streetName\" : \"streetName\",  \"city\" : \"city\"} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
